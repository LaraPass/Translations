...
return [
    ...
    */
    ...
    'teams' => [
        'module_disabled' => 'Teams Module is disabled on this app. Contact Site Administators for more info.'
    ],
    'admin' => [
        'settings' => [
            'validation' => [
        ...
        'modules' => [
            ...
            'teams' => [
                'enabled' => 'Teams module enabled successfully.',
                'updated' => 'Teams settings has been updated successfully.',
                'updated_all_teams' => 'Team Limits have been updated for all existing teams.',
                'disabled' => 'Teams module disabled successfully. Users will no longer be able to access their teams data.',
            ],
            'recaptcha' => [
                'validation' => [
        ...
        'users' => [
            'validation' => [
                ...
                'plan_name_required' => 'Plan / Membership name is required.',
                'create_teams_required' => 'Create Teams selection is required',
                'max_teams_required' => 'Max. teams limit is required',
                'max_vaults_required' => 'Max. vaults limit is required',
                'max_sites_required' => 'Max. sites limit is required',
                'max_folders_required' => 'Max. folders limit is required',
                'max_notes_required' => 'Max. notes limit is required',
            ],
            ...
            'updated_limits' => 'User Plan & Limits Updated Successfully.'
        ],
        'teams' => [
            'validation' => [
                'max_members' => 'Max. members limit is required',
            ],
            'updated_limits' => 'Team Plan & Limits Updated Successfully.'
        ],
    ],
    'profile' => [
        'validation' => [
        ...
        'in_teams' => 'You are currenly a member of 1 or more teams. Leave all the teams before you can request for your account deletion.',
    ],
    'security' => [
        'validation' => [
